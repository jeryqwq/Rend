...
function Product() {
  return (
    <div className='content' >
      ...
      <Radio.Group onChange={e => {(e.target.value)}} size="large">
        <Radio.Button value="large">租凭管理</Radio.Button>
        <Radio.Button value="default">二手设备管理</Radio.Button>
        <Radio.Button value="small">配件管理</Radio.Button>
      </Radio.Group>
      <ProTable
        request={async () => {
          return {
