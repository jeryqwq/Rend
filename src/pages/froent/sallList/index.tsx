...
function AllDevice() {
  ...
  useEffect(() => {
    (async () => {
      const res = await equipmentSalePage({
        ...pageInfo,
        ...params,
        equipName: keyword,
      });
        ...
        <div className={styles.line}>
          ...
          <Row className="rg" gutter={[20, 15]}>
            <Col>
              <Button
                size="small"
                type={!params['equipType'] ? 'primary' : 'text'}
                onClick={() => {
                  setParams({
                    ...params,
                    equipType: undefined,
        ...
        <div className={styles.line}>
          ...
          <Row className="rg" gutter={15}>
            <Col>
              <Button
                size="small"
                type={!params['equipBrand'] ? 'primary' : 'text'}
                onClick={() => {
                  setParams({
                    ...params,
            ...
            {brands.map((i: any) => (
              <Col>
                <Button
                  size="small"
                  type={
                    params['equipBrand'] === i.brandName ? 'primary' : 'text'
                  }
                  onClick={() => {
                    setParams({
                      ...params,
        ...
        <div className={styles.line}>
          ...
          <Row className="rg" gutter={15}>
            <Col>
              <Button
                size="small"
                type={!params['releaseCityName'] ? 'primary' : 'text'}
                onClick={() => {
                  setCurCity(city);
                  setParams({
                    ...params,
            ...
            {curCity.map((i) => (
              <Col style={{ marginBottom: 10 }}>
                <Button
                  size="small"
                  type={
                    params?.releaseCityName === i.label ? 'primary' : 'text'
                  }
                  onClick={() => {
                    if (i.children) {
          ...
          <Row gutter={10}>
            {list.map((i: any) => (
              <Col style={{ marginBottom: 5 }}>
                <div
                  className={`${styles['item-wrap']} ${styles.hover}`}
                ...
                >
                  <div className={`${styles['img-wrap']}`}>
                    <img width={210} src={'/lease-center/' + i.mainImgPath} />
                  </div>
                  <div className="line">
                    <div className="lf">
                      <span style={{ color: '#D90B18', fontSize: 18 }}>
                        ¥{i.salePrice}
                      </span>{' '}
                      <span className="status_prod">{'待售'}</span>
                    </div>
        ...
        <div className={styles.rg}>
          ...
          {recommons.map((i: any) => (
            <div
              ...
              style={{ padding: 0, width: 220, cursor: 'pointer' }}
              onClick={() => {
                history.push('/productDetail?id=' + i.id);
              }}
            >
              <div
                ...
                style={{ padding: 0, height: 220 }}
              >
                <img width={220} src={'/lease-center/' + i.mainImgPath} />
              </div>
              <div className="line">
                <div className="lf">
                  <span style={{ color: '#D90B18', fontSize: 18 }}>
