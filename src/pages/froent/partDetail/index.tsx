...
function ProductDetail() {
  ...
  useEffect(() => {
    (async () => {
      const res = await commonRequest(`/equipmentParts/${id}`, {
        method: 'get',
      });
      if (res.code === '0') {
        setProduct(res.data);
        ...
        <div className="lf">
          ...
          {commonStore.map((i) => (
            ...
            >
              ...
              />
              <div className="ot-tit">{i.partsName}</div>
              <div className="price">
                ¥{i.price}{' '}
        ...
        <div className="rg">
          ...
          <div className="prod-cont">
            ...
            >
              ...
              <Descriptions.Item label="配件型号">
                {productInfo.partsModel}
              </Descriptions.Item>
          ...
          {storeOther.map((i) => (
            ...
            >
              <img
                ...
                alt=""
              />
              <div className="itit">{i.partsName}</div>
              <div className="price">
                ¥{i.price}元{' '}
                <span style={{ color: '#666666', fontSize: 13 }}></span>
              </div>
